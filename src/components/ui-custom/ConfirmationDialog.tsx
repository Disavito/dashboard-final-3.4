...
interface ConfirmationDialogProps {
  ...
  title: string;
  description: string;
  data?: Record<string, any>; // Ahora es opcional
...
const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
  ...
  title,
  description,
  data = {}, // Valor por defecto para evitar el crash
      ...
      <DialogContent className="sm:max-w-[480px] bg-card border-border rounded-xl shadow-lg">
        ...
        <DialogFooter className="mt-4">
          ...
          <Button
            ...
            disabled={isConfirming}
          >
            {isConfirming ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : confirmButtonText}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
